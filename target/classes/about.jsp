...
<body>
    ...
    <div class="about">
        ...
        <div id="me_text">
            ...
            <p>感谢那些曾经帮助过我的人，因为有你们我才会变得如此的优秀。----By:yxw</p>
        </div>
    ...
    <aside class="right">
        <div class="about_c">
            <br/>
            <p>网名：非一般的感觉</p>
            <p>姓名：<a href="https://github.com/OyXw1" target="_blank">yxw</a></p>
            <p>星座：xxx座</p>
            <p>现居：xx省-xx市</p>
...
<footer>
    <p><span>Design By:<a href="https://github.com/OyXw1" target="_blank">yxw</a></span><span>网站地图</span><span><a href="/">网站统计</a></span>
    </p>
</footer>
